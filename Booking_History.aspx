...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table cellspacing="1" class="auto-style2">
        ...
        <tr>
            <td class="auto-style14">&nbsp;</td>
            <td class="auto-style4" colspan="3">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Member_ID], [Member_Name], [Booking_ID], [Origin], [Destination], [Date], [Time] FROM [Bookings] WHERE ([Member_ID] = @Member_ID)">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="lbl_id" Name="Member_ID" PropertyName="Text" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
