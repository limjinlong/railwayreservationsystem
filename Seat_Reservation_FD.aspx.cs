...
public partial class Seat_Reservation_FD : System.Web.UI.Page
{
    ...
    {
        if (ddl_coach.Text == "" || ddl_seat.Text == "" || ddl_seatrow.Text == "" )
        {
            lbl_error.Text = "Please Select Coach, Row or Seat!";
        }
        else
        {
            lbl_error.Text = "";
            ...
            if (checkseat < 1)
            {
                ...
                string query = "insert into DummyBookings (Seat_ID, Train_ID, Train_Name, Route_ID, Origin, Destination, Date, Time, Price) values (@seatid, @trainid, @trainname, @routeid, @origin, @destination, @date, @time, @price)";
    ...
    protected void btn_confirm_Click(object sender, EventArgs e)
    {
        ...
        {
            string query2 = "insert into Bookings (Seat_ID, Train_ID, Train_Name, Route_ID, Origin, Destination, Date, Time, Price) values (@seatid, @trainid, @trainname, @routeid, @origin, @destination, @date, @time, @price)";
